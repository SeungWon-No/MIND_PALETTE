        ...
        <div class="column-left">
            <div class="policy-wrap">
                <div class="counseling-list__heading">
                    <h3 class="counseling-list__tit">이용약관</h3>
                </div>
                <div class="policy-content">
                    ...
                    <br>
                    <p>1. 회원 : 회사와 서비스 이용에 관한 계약을 체결한 자</p>
                    <p>2. 비회원 : 회원이 아니면서 회사가 제공하는 서비스를 이용하는 자</p>
                    <p>3. 상담사 : 회원이면서 회사가 제공하는 서비스에서 전문 상담사로 활동하는 자</p>
                    <p>4. 이용자 : 회사의 사이트에 접속하여 이 약관에 따라 회사가 제공하는 제반 서비스 등을 이용하는 회원 및 비회원</p>
                    <p>5. 콘텐츠 : 정보통신망이용촉진 및 정보보호 등에 관한 법률 제2조 제1항 제1호의 규정에 의한 정보통신망에서 사용되는 부호·문자·음성·음향·이미지 또는 영상 등으로 표현된 자료 또는 정보로서, 그 보존 및 이용에 있어서 효용을 높일 수 있도록 전자적 형태로 제작 또는 처리된 것</p>
                    <p>6. 아이디(ID) : 회원 식별과 회원의 서비스 이용을 위하여 회원이 선정한 이메일 주소</p>
                    <p>7. 비밀번호 : 회원이 통신상의 자신의 비밀을 보호하기 위해 선정한 문자와 숫자의 조합</p>
                    <h5>제4조 (회사정보 등의 제공)</h5>
                    <p class="no-indent">
                        회사는 다음 각 호의 사항을 회원이 알아보기 쉽도록 서비스 내에 표시합니다.<br>
                        다만, 개인정보처리방침과 약관은 회원이 연결화면을 통하여 볼 수 있도록 할 수 있습니다.</p>
                    <br>
                    <p class="no-indent">
                        1. 상호 및 대표자의 성명<br>
                    ...
                    <h5 class="space">[제2장 서비스 회원가입]</h5>
                    <h5>제6조 (이용계약의 성립)</h5>
                    <p>
                    ...
                    <h5>제7조 (회원가입)</h5>
                    <p>
                        1. 회원 가입시 서비스에 다음 사항을 기재해야 합니다.<br>
                        ① 이메일 주소<br>
                        ② 비밀번호<br>
                        ③ 이름<br>
                        ④ 휴대전화<br>
                    ...
                    <p>
                        2. 회사는 상기 이용자의 신청에 대하여 회원가입을 승낙함을 원칙으로 합니다. 다만, 회사는 다음 각 호에 해당하는 신청에 대하여는 승낙을 제한할 수 있고, 그 사유가 해소될 때까지 승낙을 유보할 수 있습니다.<br>
                    ...
                    <br>
                    <p>
                        3. 회원가입 계약의 성립 시기는 회사의 승낙이 이용자에게 도달한 시점으로 합니다.
                    </p>
                    <h5>제8조 (미성년자의 회원가입에 관한 특칙)</h5>
                    <p>회사는 14세 미만 이용자에 대하여는 가입을 취소 또는 불허합니다.</p>
                    <h5>제9조 (회원정보의 변경)</h5>
                    <p>
                    ...
                    <h5>제10조 (회원에 대한 통지)</h5>
                    <p>
                        1. 회사가 회원에 대한 통지를 하는 경우 회원이 지정한 이메일, 휴대전화로 할 수 있습니다.
                    </p>
                    <p>
                        2. 회사는 회원 전체에 대한 통지의 경우 7일 이상 회사의 공지사항 게시판에 게시함으로써 제1항의 통지에 갈음할 수 있습니다. 다만, 회원 본인의 거래와 관련하여 중대한 영향을 미치는 사항에 대하여는 제1항의 통지를 합니다.
                    </p>
                    <h5>제11조 (회원탈퇴 및 자격 상실 등)</h5>
                    <p>
                    ...
                    <p>
                        ...
                        ② 회사의 서비스 이용 대금, 기타 회사의 서비스이용에 관련하여 회원이 부담하는 채무를 기일에 이행하지 않는 경우<br>
                        ③ 다른 사람의 회사의 서비스이용을 방해하거나 그 정보를 도용하는 등 전자상거래 질서를 위협하는 경우<br>
                    ...
                    <h5 class="space">[제3장 서비스 제공 및 이용]</h5>
                    <h5>제12조 (서비스의 내용 및 이용)</h5>
                    <p>
                        1. 회사가 제공하는 서비스의 내용은 다음과 같습니다. (서비스 리스트)<br>
                        ① 아이 그림 분석(HTP) 서비스<br>
                        ② 회원과 상담사의 상담 연계 서비스<br>
                        ③ 아이 심리 상담 서비스<br>
                        ④ 알리미 서비스<br>
                        ⑤ 기타 회사가 자체적으로 개발하거나 타사와의 협력 관계, 계약 등을 통해 회원에게 제공할 일체의서비스<br>
                    </p>
                    <p>
                        2.회사는 필요한 경우 서비스의 내용을 추가 또는 변경할 수 있습니다. 이 경우 회사는 추가 또는 변경내용을 본 약관 제10조에 따라 회원에게 통지합니다.
                    </p>
                    <h5>제13조 (서비스의 요금)</h5>
                    <p>
                    ...
                    <h5>제17조 (서비스 제공의 중지)</h5>
                    <p>
                        1. 회사는 다음 각 호에 해당하는 경우 서비스의 제공을 완전히 중지할 수 있습니다.<br>
                        ① 설비의 보수 등을 위하여 부득이한 경우<br>
                        ② 전기통신사업법에 규정된 기간통신사업자가 전기통신서비스를 중지하는 경우<br>
                        ③ 기타 회사가 서비스를 제공할 수 없는 사유가 발생한 경우.<br>
                        ④ 회사는 국가비상사태, 정전, 서비스 설비의 장애 또는 서비스 이용의 폭주 등으로 정상적인 서비스 이용에 지장이 있는 경우 서비스의 전부 또는 일부를 제한하거나 중지할 수 있습니다.
                    </p>
                    <br>
                    <p>
                    ...
                    <h5 class="space">[제4장 서비스와 관련한 권리 및 의무 관계]</h5>
                    <h5>제18조 (회사의 의무)</h5>
                    <p>
                    ...
                    <p>
                        3. 본조 제①, ②항의 긴급상황 대처 전 회사는 공지나 이메일을 통하여 고객에게 이를 알려야 합니다. 만약 상황이 긴급하여 이를 알리기에 어려움이 있다면, 회사는 대처 후라도 이를 공지나 이메일을 통하여 알려야 합니다.
                    </p>
                    <h5>제19조 (개인정보의 보호)</h5>
                    <p>
                    ...
                    <h5>제21조 (게시물 또는 내용물의 삭제)</h5>
                    <p>
                        회사는 회원이 게시하거나 등록하는 서비스 내의 내용물 등이 제20조의 규정에 위반되거나 회사 소정의 게시기간을 초과하는 경우 사전 통지나 동의 없이 이를 삭제할 수 있습니다.
                    </p>
                    <h5>제22조 (회원의 아이디(ID) 및 비밀번호에 대한 의무)</h5>
                    <p>
                        1. 회원은 서비스를 이용하는 경우 아이디(ID) 및 비밀번호를 사용해야 합니다.
                    </p>
                    <p>2. 아이디(ID) 및 비밀번호에 대한 모든 관리의 책임은 회원에게 있습니다.</p>
                    <p>3. 회원은 아이디(ID) 및 비밀번호를 제3자에게 이용하게 해서는 안됩니다.</p>
                    <p>4. 아이디(ID) 및 비밀번호의 관리상 불충분, 사용상의 과실, 제3자의 사용 등에 의한 손해의 책임은 회원이 집니다.</p>
                    <p>5. 회원은 아이디(ID) 및 비밀번호를 도난당하거나 제3자에게 사용되고 있음을 인지한 경우에는 바로 회사에 통보하고 회사의 지시가 있는 경우에는 그에 따라야 합니다.</p>
                    <h5 class="space">[제5장 기타]</h5>
                    ...
                    <p>
                        3. 회원이 작성한 게시물에 대한 모든 권리 및 책임은 이를 게시한 회원에게 있습니다. 단, 회원이 회사에제공한 공개적인 게시물에 대한 권리는 회사와 개인이 공동으로 소유합니다.
                    </p>
                    <h5>제24조 (양도금지)</h5>
                    <p>
                    ...
                    <h5>제26조 (면책)</h5>
                    <p>
                        1. 회사는 회원이 서비스에 게재한 정보, 자료, 사실의 정확성, 신뢰성 등 그 내용에 관하여는 어떠한 책임을 부담하지 아니하고, 회원은 자기의 책임아래 서비스를 이용하며, 서비스를 이용하여 게시 또는 전송한 자료 등에 관하여 손해가 발생하거나 자료의 취사선택, 기타 서비스 이용과 관련하여 어떠한 불이익이 발생하더라도 이에 대한 모든 책임은 회원에게 있습니다.
                    </p>
                    <p>
                        2. 회사가 제공하는 정보와 자료는 거래의 목적으로 이용될 수 없 습니다. 따라서 본 서비스의 정보와 자료 등에 근거한 거래는 전적으로 회원자신의 책임과 판단아래 수행되는 것이며, 회사는 회원이 서비스의 이용과 관련하여 기대하는 이익에 관하여 책임을 부담하지 않습니다.
                    </p>
                    <p>
                        3. 회원 아이디(ID)와 비밀번호의 관리 및 이용상의 부주의로 인하여 발생되는 손해 또는 제3자에 의한 부정사용 등에 대한 책임은 모두 회원에게 있습니다.
                    </p>
                    <h5>제27조 (분쟁의 해결)</h5>
                    <p class="no-indent">
                    ...
                    <h5 class="space">부칙</h5>
                    <h5>제1조 (시행일)</h5>
                    <p>이 약관은 2022년 12월 27일부터 적용합니다.</p>
                </div>
            </div>
        </div> <!--column-left end-->
